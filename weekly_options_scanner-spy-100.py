...
TICKERS = [
    ...
    "JPM", "TSLA", "WMT", "UNH", "XOM", "V", "MA", "PG", "COST", "JNJ",
    "HD", "ORCL", "ABBV", "BAC", "NFLX", "MRK", "KO", "CRM", "CVX", "ADBE",
    "AMD", "PEP", "TMO", "LIN", "CSCO", "ACN", "MCD", "ABT", "WFC", "IBM",
    "PM", "GE", "ISRG", "INTU", "NOW", "CAT", "GS", "QCOM", "TXN", "AMGN",
    "MS", "AXP", "RTX", "BLK", "T", "NEE", "HON", "UNP", "LOW", "PFE",
    "BKNG", "DE", "VRTX", "AMAT", "SYK", "PLTR", "SBUX", "BA", "SCHW", "ELV",
    "TJX", "BMY", "SPGI", "GILD", "ADP", "MDT", "MMC", "LRCX", "CB", "PLD",
    "AMT", "CI", "MU", "PANW", "TMUS", "SO", "CEG", "CL", "REGN", "KLAC",
    "PYPL", "CME", "INTC", "ZTS", "APH", "ABNB", "ITW", "CRWD", "MCK", "MSI",
]
...
class SPYOpenInterestScanner(QCAlgorithm):
    ...
    def _scan(self):
        ...
        # Build output
        lines = []
        lines.append(f"SPY Open Interest Scanner — {today}  (target expiry ~{WEEKS_OUT} weeks out)")
        ...
        self.ObjectStore.Save("oi_scan_spy100", "\n".join(lines))
        self.Log(f"\nSaved to ObjectStore key 'oi_scan_spy100' ({len(lines)} lines)")
